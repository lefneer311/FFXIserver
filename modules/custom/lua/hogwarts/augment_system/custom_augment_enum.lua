...
augmentData.augmentTable = {
    ...
    -- Tier 1 Augments
    [1] = {
        [2004] = { augmentID = 18, requiredQty = 3, power = 0, materialName = "Carapace Powder", tier = 1, desc = "HP/MP +33" }, -- HP/MP +33
        ...
        [2113] = { augmentID = 146, requiredQty = 6, power = 2, materialName = "Baking Soda", tier = 1, desc = "Dual Wield +4" }, -- Dual Wield +3
    ...
    -- Tier 2 Augments
    [2] = {
        [1691] = { augmentID = 33, requiredQty = 3, power = 17, materialName = "Giant Scale", tier = 2, desc = "Defense +18" }, -- Defense +18
        ...
        [906] = { augmentID = 740, requiredQty = 3, power = 3, materialName = "Starmite Shell", tier = 2, desc = "Main Hand Damage +6" }, -- Main Hand Damage +4
    },
    -- Tier 3 Augments
    [3] = {
...
[6] = {
    ...
    [1943] = { augmentID = 53,  requiredQty = 1, power = 149, materialName = "White Rivet",        tier = 6, desc = "TP Bonus +150" }, -- TP Bonus +150
