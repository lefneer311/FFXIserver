...
-- !pos -30.3609 0.000 36.0823 Rot 44 Zone: 230
-----------------------------------
require('modules/module_utils')
require('scripts/zones/Southern_San_dOria/Zone')
require('scripts/globals/player')
-----------------------------------
local m = Module:new('Dragoon_Class_Shop')
...
m:addOverride('xi.zones.Southern_San_dOria.Zone.onInitialize', function(zone)
    ...
    local Kain = zone:insertDynamicEntity({
        ...
        onTrigger = function(player, npc)
            ...
            if player:getMainJob() == xi.job.DRG then
                ...
                elseif player:getMainLvl() >= 99 then
                    ...
                    player:PrintToPlayer('I, like you, once walked the path of the Dragoon.', 0, npc:getPacketName())
                ...
                if player:getMainJob() ~= xi.job.RDM and player:getMainLvl() >=30 then
