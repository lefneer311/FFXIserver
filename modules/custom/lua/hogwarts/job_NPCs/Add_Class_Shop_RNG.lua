...
-----------------------------------
local m = Module:new('Class_Shop_RNG')
...
m:addOverride('xi.zones.Windurst_Woods.Zone.onInitialize', function(zone)
    ...
    local Rangerrr = zone:insertDynamicEntity({
        ...
        onTrigger = function(player, npc)
            ...
            if player:getMainJob() == xi.job.RNG then
                ...
                if player:getMainJob() ~= xi.job.RNG and player:getMainLvl() >=30 then
