...
-----------------------------------
local m = Module:new('Class_Shop_BRD')
...
m:addOverride('xi.zones.RuLude_Gardens.Zone.onInitialize', function(zone)
    ...
    local Geoffrey = zone:insertDynamicEntity({
        ...
        onTrigger = function(player, npc)
            ...
            if player:getMainJob() == xi.job.BRD then
                ...
                if player:getMainJob() ~= xi.job.BRD and player:getMainLvl() >=30 then
