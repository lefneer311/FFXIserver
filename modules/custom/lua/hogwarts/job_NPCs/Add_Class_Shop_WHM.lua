...
-----------------------------------
local m = Module:new('Class_Shop_WHM')
...
m:addOverride('xi.zones.Southern_San_dOria.Zone.onInitialize', function(zone)
    ...
    local Rosa = zone:insertDynamicEntity({
        ...
        onTrigger = function(player, npc)
            ...
            if player:getMainJob() == xi.job.WHM then
                ...
                elseif player:getMainLvl() >= 80 and player:getMainLvl() <= 98 then
                    player:PrintToPlayer('It is time these things become available to you, healer.', 0, npc:getPacketName())
                    stock = {
                        17643,5000,-- Honor Sword
                        26410,2500,-- Diamond Buckler
                        18276,1250000,-- Excalibur
                ...
                elseif player:getMainLvl() >= 99 then
                    ...
                    player:PrintToPlayer('I, like you, once walked the path of the Cleric.', 0, npc:getPacketName())
                ...
                if player:getMainJob() ~= xi.job.WHM and player:getMainLvl() >=30 then
