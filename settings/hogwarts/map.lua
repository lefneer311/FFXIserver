...
xi.settings.map =
{
    ...
    -- Weaponskill points per skillchain element - whole numbers only, retail is 2
    ...
    CRAFT_HQ_CHANCE_MULTIPLIER = 2.0,
    ...
    MOB_TP_MULTIPLIER    = 1.00,
    PET_TP_MULTIPLIER    = 1.00,
    PLAYER_TP_MULTIPLIER = 1.00,
    TRUST_TP_MULTIPLIER  = 1.00,
    FELLOW_TP_MULTIPLIER = 1.00,

    -- Adjust max HP pool for NMs, regular mobs, players, and trusts/fellows. Acts as a multiplier, so default is 1.
    NM_HP_MULTIPLIER        = 1.00,
    MOB_HP_MULTIPLIER       = 1.00,
    ...
    NM_MP_MULTIPLIER        = 1.00,
    MOB_MP_MULTIPLIER       = 1.00,
    ALTER_EGO_MP_MULTIPLIER = 1.00,
