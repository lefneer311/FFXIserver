...
xi.settings.main =
{
    ...
    SERVER_MESSAGE =
        ...
        "Check your quests > Records of Eminence (ROE) > Available Objectives > Tutorial to learn to play",
    ...
    MONSTROSITY_TELEPORT_TO_FERETORY = 1,   -- Return to Feretory instead of the zone where you entered Feretory when Relinquishing or after death.
    MONSTROSITY_TRIGGER_NPCS         = 1,   -- Allow Monipulators to trigger NPCs outside of the Feretory.
    MONSTROSITY_DONT_WIPE_BUFFS      = 1,   -- If set, buffs won't be wiped when changing species in the Feretory.
    ...
    ABYSSEA_CRUOR_REAPER_BONUS_STEP    = 0.2,       -- Multiplier at the end of the calculation; eg. 0.2 = 120% and 0.15 = 115%.  Default (0.2)
    ...
    ENABLE_LIMITED_TIME_TRUST = 1, -- 0 = disabled, 1 = Cornelia, 2 = Matsui-P, will get automatically added to players trust list if the player has a trust permit KI.
    ...
    STONESKIN_CAP                   = 475,   -- Soft cap for hp absorbed by stoneskin
    ...
    ENM_COOLDOWN                 = 0.5,   -- Number of hours before a player can obtain same KI for ENMs (default: 5 days)
	...
	--MAGIAN_TRIALS_MOBKILL_MULTIPLIER = 10,
    --MAGIAN_TRIALS_TRADE_MULTIPLIER   = 10,
    ...
    --SPIKE_EFFECT_DURATION           = 540,   -- the duration of RDM, BLM spikes effects (not Reprisal)
    --ELEMENTAL_DEBUFF_DURATION       = 360,   -- base duration of elemental debuffs
	...
	-- EINHERJAR
    --EINHERJAR_ENABLED    = true, -- Enable the Einherjar system implemented by @Sruon in March, 2025 (Still in development)
}
