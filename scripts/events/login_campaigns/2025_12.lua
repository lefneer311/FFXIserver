-- Source: BG Wiki Repeat Login Campaign/Past Login Campaign Rewards, December 2024 same-month reward draft; official December 2025 schedule/featured items reviewed where BG Past currently stops at November 2025.
-- Verification: drafted as a same-month analogue using repository xi.item constants; source rewards without constants were omitted.
