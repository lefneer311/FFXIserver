-- Source: Existing LandSandBoat login_campaign_data.lua table.
-- Verification: not retail-source-complete; kept as explicit reviewed runtime data until monthly retail backfill.
-- Notes: intentionally preserves named xi.item constants and commented candidate rewards from the legacy table.
